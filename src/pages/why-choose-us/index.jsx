...
export default function WhyChooseUs() {
  return (
    <>
    <div className=' bg-cover bg-center relative' style={{backgroundImage:'url(/img/album/chooseus.jpg)'}}>
    ...
    <div className="mt-5 container px-[5%] mx-auto">
      <div className="grid grid-cols-2 gap-5">
        ...
        <div className="">
          <img className='w-full h-[500px] object-cover object-bottom' src="/img/album/additional.jpg" alt="" />
        </div>
      </div>
    </div>
