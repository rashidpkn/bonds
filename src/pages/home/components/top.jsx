  ...
  return (
    <section className='container mx-auto text-center lg:text-left'>
        <div className="grid lg:grid-cols-2 gap-5 pt-[5%] px-5">
            <img src="/img/home/uk.jpg" className='rounded-lg h-[500px] w-full object-cover object-bottom' alt="Our Top UK Picks" />
            <div className="flex flex-col justify-center items-center lg:items-start gap-5">
                ...
                <Link to={path.toUK} className='px-6 py-3 bg-[#52bce8] rounded-lg text-black'>View All</Link>
            </div>
            ...
            <div className="flex flex-col justify-center items-center lg:items-start gap-5">
                ...
                <Link to={path.topAustralian} className='px-6 py-3 bg-[#52bce8] rounded-lg text-black'>View All</Link>
            </div>
            <img src="/img/home/australian.jpg" className='rounded-lg h-[500px] w-full object-cover' alt="Our Top Australian Picks  " />


            <img src="/img/home/canadian.jpg" className='rounded-lg h-[500px] w-full object-cover' alt="Our Top Canadian Picks" />
            <div className="flex flex-col justify-center items-center lg:items-start gap-5">
                ...
                <Link to={path.topCanadian} className='px-6 py-3 bg-[#52bce8] rounded-lg text-black'>View All</Link>
            </div>
            ...
            <div className="flex flex-col justify-center items-center lg:items-start gap-5">
                ...
                <Link to={path.topEuropean} className='px-6 py-3 bg-[#52bce8] rounded-lg text-black'>View All</Link>
            </div>
            <img src="/img/home/european.jpg" className='rounded-lg h-[500px] w-full object-cover' alt="Our Top European Picks" />
