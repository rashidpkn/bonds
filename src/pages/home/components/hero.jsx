...
export default function Hero() {
  return (
    <section className='h-[75vh] font-lato bg-no-repeat bg-cover bg-right '  style={{backgroundImage:'url(/img/home/bg.jpg)'}}>
            <div className=" h-full px-[10%] flex flex-col justify-center bg-black/30  items-center lg:items-start gap-5 text-center lg:text-left">
                    ...
                    <Link to={path.whyChooseBonds} className='px-6 py-3 bg-[#133269]  text-white rounded-lg' title='Why Choose Us' aria-label='Why Choose Us'>
                            Why Choose Bonds
                    </Link>
            </div>
    </section>
