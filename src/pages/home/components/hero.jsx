...
export default function Hero() {
  return (
    <section className='h-[75vh] font-lato bg-no-repeat bg-cover bg-right'  style={{backgroundImage:'url(/img/home/hero-banner.jpg)'}}>
            <div className="container mx-auto h-full flex flex-col justify-center items-center lg:items-start gap-5 text-center lg:text-left">
                    ...
                    <h1 className='text-5xl font-bold text-white'>Bond Market Quotes</h1>
                    ...
                    <Link to={path.whyChooseBonds} className='px-6 py-3 bg-[#071d49]  text-white rounded-lg' title='Why Choose Us' aria-label='Why Choose Us'>
                            Why Choose Bonds
                    </Link>
            </div>
    </section>
