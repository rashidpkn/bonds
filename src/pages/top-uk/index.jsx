...
export default function TopUK() {
  return (
    <>
<div className=' bg-cover bg-bottom relative ' style={{backgroundImage:'url(/img/album/uk.jpg)'}}>
        <div className="flex flex-col gap-5 justify-center items-center w-full min-h-[500px] bg-black/40 text-white text-center">
          <h1 className='text-2xl lg:text-5xl'>Our Top UK Picks</h1>
        </div>
    </div>

    <div className="my-10 text-center space-y-10 container mx-auto px-[5%]">
    <h2 className='text-2xl lg:text-5xl'>Our Top UK Picks</h2>
        <p className='text-black/60 '>This list is designed to keep investors up to date with the highest yielding bonds available on the UK market. All bonds have been carefully selected based on the yield and security of the issuer.</p>
